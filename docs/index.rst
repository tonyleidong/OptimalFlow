...
------------------------------------------------------------------
      ...
      * Algorithms scalable - Each module could add new algorithms easily due to its ensemble code structure;
      * Custom parameters - Support custom settings for elastic requirements.
